...
export function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-brand-dark/95 backdrop-blur-xl shadow-lg shadow-black/10' : 'bg-brand-dark/95 backdrop-blur-xl shadow-lg shadow-black/10'}`}>
